...
DioPortUI::DioPortUI(QWidget *parent, int index, quint8 state, QString *images)
    : QWidget(parent)
{
    this->key = index;
    this->state = state;
